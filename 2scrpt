var X00Pokecoins = ['80,000 Pokecoins','30,000 Pokecoins','25,000 Pokecoins','34,000 Pokecoins','70,000 Pokecoins','11,000 Pokecoins']
var X00Processes = [
  ...
  { X00Percent: 74, X00Text: 'Generating Resources..' },
  { X00Percent: 74, X00Text: 'Generating Resources...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins MCPE...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins MCPE...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins MCPE...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins MCPE...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins MCPE...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins T-Items.' },
  { X00Percent: 77, X00Text: 'Injecting XCoins T-Items..' },
  { X00Percent: 77, X00Text: 'Injecting XCoins T-Items...' },
  { X00Percent: 77, X00Text: 'Injecting XCoins T-Items....' },
  { X00Percent: 77, X00Text: 'Injecting XCoins T-Items.....' },
  { X00Percent: 77, X00Text: 'Injecting Mods Mods.' },
  { X00Percent: 77, X00Text: 'Injecting Mods Mods..' },
  { X00Percent: 77, X00Text: 'Injecting Mods Mods...' },
  { X00Percent: 77, X00Text: 'Injecting Mods Mods....' },
  { X00Percent: 77, X00Text: 'Injecting Mods Mods.....' },
  { X00Percent: 77, X00Text: 'Unlock Key Protect Mods.' },
  { X00Percent: 77, X00Text: 'Unlock Key Protect Mods..' },
  { X00Percent: 77, X00Text: 'Unlock Key Protect Mods...' },
  { X00Percent: 77, X00Text: 'Unlock Key Protect Mods....' },
  { X00Percent: 77, X00Text: 'Unlock Key Protect Mods.....' },
  { X00Percent: 78, X00Text: 'Generating Resources... done!' },
  ...
  { X00Percent: 96, X00Text: 'Finalizing Process.' },
  { X00Percent: 96, X00Text: 'Finalizing Process..' },
  { X00Percent: 97, X00Text: 'Finalizing Process...' },
  { X00Percent: 98, X00Text: 'Pending.' },
  { X00Percent: 98, X00Text: 'Pending..' },
  { X00Percent: 98, X00Text: 'Pending...' },
  { X00Percent: 98, X00Text: 'Pending....' },
...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;">' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="label label-default" style="font-weight: bold;">has generated</span> <span class="label label-success" style="font-weight: bold;">' + X00Pokecoins[X00Random(0, X00Pokecoins.length)] + ' </span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
...
$(function() {
  ...
  $('#X00ButtonStart').click(function() {
    if ($('#X00InputUsername').val() == '') {$('#X00InputUsername').focus();}
	  ...
	  $('#X06Pokecoins').html($('#X06InputPokecoins').val());
